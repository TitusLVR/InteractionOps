...
class IOPS_State():
    ...
    mesh_dict["VIEW_3D"]["MESH"]["OBJECT"]["F1"] = lambda: functions.edit_mode_switch("VERT")  # Switch to VERTEX
    mesh_dict["VIEW_3D"]["MESH"]["OBJECT"]["F2"] = lambda: functions.edit_mode_switch("EDGE")  # Switch to EDGE
    mesh_dict["VIEW_3D"]["MESH"]["OBJECT"]["F3"] = lambda: functions.edit_mode_switch("FACE")  # Switch to FACE
    mesh_dict["VIEW_3D"]["MESH"]["OBJECT"]["F4"] = ()  # Move to cursor
    mesh_dict["VIEW_3D"]["MESH"]["OBJECT"]["F5"] = ()  # Visual pivot

    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["VERT"]["F1"] = lambda: functions.object_mode_switch("OBJECT")  # Switch to OBJECT
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["VERT"]["F2"] = ()  # Switch to EDGE
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["VERT"]["F3"] = ()  # Switch to FACE
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["VERT"]["F4"] = ()  # Cursor/Origin
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["VERT"]["F5"] = ()  # ???

    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["EDGE"]["F1"] = ()  # Switch to VERTEX
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["EDGE"]["F2"] = ()  # Switch to OBJECT
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["EDGE"]["F3"] = ()  # Switch to FACE
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["EDGE"]["F4"] = ()  # Cursor/Origin
    ...
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["FACE"]["F3"] = ()  # Switch to OBJECT
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["FACE"]["F4"] = ()  # Cursor/Origin
    mesh_dict["VIEW_3D"]["MESH"]["EDIT_MESH"]["FACE"]["F5"] = ()  # Align to face normal

    # CURVE DICTIONARY

    curve_dict["VIEW_3D"]["CURVE"]["F1"] = ()  # Switch to EDIT
    curve_dict["VIEW_3D"]["CURVE"]["F2"] = ()  #
    curve_dict["VIEW_3D"]["CURVE"]["F3"] = ()  #
    curve_dict["VIEW_3D"]["CURVE"]["F4"] = ()  #
    curve_dict["VIEW_3D"]["CURVE"]["F5"] = ()  #
...
mesh_dict_v2 = {
    "VIEW_3D": {
        "MESH": {
            "OBJECT": {
                "F1": lambda: functions.edit_mode_switch("VERT"),
                "F2": lambda: functions.edit_mode_switch("VERT"),
                "F2": lambda: functions.edit_mode_switch("VERT"),
                "F2": lambda: functions.edit_mode_switch("VERT"),
                "F2": lambda: functions.edit_mode_switch("VERT"),
            },
            "EDIT_MESH": {
                "VERT": {
                    "F1": lambda: functions.object_mode_switch("OBJECT"),
                    "F1": lambda: functions.object_mode_switch("OBJECT"),
                    "F1": lambda: functions.object_mode_switch("OBJECT"),
                    "F1": lambda: functions.object_mode_switch("OBJECT"),
                    "F1": lambda: functions.object_mode_switch("OBJECT"),
