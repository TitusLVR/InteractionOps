...
class IOPS_OT_Drop_It(bpy.types.Operator):
    ...
    drop_it_align_to_surf: BoolProperty(
        name="Align", description="Align to surface", default=True
    )
    ...
    use_local_z: BoolProperty(
        name="Use Local Z", description="Object local Z axis as direction", default=True
    )
            ...
            if track_axis != up_axis:
                for ob in selected_objs:
                    ...
                    if self.use_local_z:
                        ...
                        direction = Vector(
                            (
                                self.drop_it_direction_x,
                                self.drop_it_direction_y,
                                self.drop_it_direction_z,
                            )
                        )
                    ...
                    if bpy.app.version[1] > 90:
                        result, location, normal, __, __, __ = (
                        ...
                        result, location, normal, __, __, __ = (
                            bpy.context.scene.ray_cast(
                                view_layer, obj_origin, direction, distance=1.70141e38
                            )
                        )
                    ...
                    if result:
                        ...
                        if self.drop_it_align_to_surf:
                            ...
                            mx_rot = (
                                normal.to_track_quat(track_axis, up_axis)
                                .to_matrix()
                                .to_4x4()
                            )
                        ...
                        vec = Matrix.Translation(
                            (
                                self.drop_it_offset_x,
                                self.drop_it_offset_y,
                                self.drop_it_offset_z,
                            )
                        )
