...
# the save tuple can't round-trip them (no `any` flag, and a load would
# route the space-typed "3D View" widget entry into the space-agnostic
# "Window" keymap as a duplicate global LMB binding). Their owner
# (ui/widgets/events.py) registers them itself at addon register.
NEVER_SAVE = {"iops.widget_interact"}
