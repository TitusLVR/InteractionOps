...
class IOPS_Theme(bpy.types.PropertyGroup):
    ...
    color_closest_point:   _color((0.302, 1.000, 0.620, 1.00), "Closest")
    color_active_point:    _color((0.302, 0.816, 1.000, 1.00), "Active")
    color_locked_point:    _color((1.000, 0.722, 0.302, 1.00), "Locked")
    color_preview_point:   _color((0.302, 0.816, 1.000, 0.50), "Preview")
    color_point_outline:   _color((0.000, 0.000, 0.000, 1.00), "Outline")
    ...
    point_size_preview:    FloatProperty(name="Preview", default=8.0,  min=2.0, max=48.0)

    # --- Line ---
    color_line:            _color((1.000, 1.000, 1.000, 0.60), "Default")
    color_closest_line:    _color((0.302, 1.000, 0.620, 1.00), "Closest")
    color_active_line:     _color((0.302, 0.816, 1.000, 1.00), "Active")
    color_locked_line:     _color((1.000, 0.722, 0.302, 1.00), "Locked")
    color_preview_line:    _color((0.302, 0.816, 1.000, 0.50), "Preview")
    ...
    line_width_active:     FloatProperty(name="Active",  default=2.5, min=0.5, max=12.0)
    line_width_locked:     FloatProperty(name="Locked",  default=3.0, min=0.5, max=12.0)
    line_width_preview:    FloatProperty(name="Preview", default=2.0, min=0.5, max=12.0)

    # --- Text ---
    color_text:            _color((1.000, 1.000, 1.000, 1.00), "Default")
    color_closest_text:    _color((0.302, 1.000, 0.620, 1.00), "Closest")
    color_active_text:     _color((0.302, 0.816, 1.000, 1.00), "Active")
    color_locked_text:     _color((1.000, 0.722, 0.302, 1.00), "Locked")
    color_preview_text:    _color((0.302, 0.816, 1.000, 0.85), "Preview")
    text_size_default:     IntProperty(name="Default", default=12, min=8, max=64)
    text_size_closest:     IntProperty(name="Closest", default=13, min=8, max=64)
    text_size_active:      IntProperty(name="Active",  default=14, min=8, max=64)
    text_size_locked:      IntProperty(name="Locked",  default=14, min=8, max=64)
    ...
    # --- HUD ---
    color_hud_key:         _color((1.000, 0.722, 0.302, 1.00), "Key glyph")
    color_hud_label_on:    _color((1.000, 1.000, 1.000, 1.00), "Label (active)")
    color_hud_label_off:   _color((0.533, 0.541, 0.557, 0.85), "Label (inactive)")
    color_hud_label_disabled:_color((0.220, 0.220, 0.235, 0.85), "Label (disabled)")
    shadow_enabled:        BoolProperty(name="Shadow", default=True)
    shadow_color:          _color((0.0, 0.0, 0.0, 0.7), "Shadow color")
    shadow_blur:           IntProperty(name="Shadow blur", default=3, min=0, max=10)
